...
/**
 * Created by lha on 2017/3/31 0031.
 *
 * 统计应用的一些信息
 *
 */
...
public class StatisticsInfo {
    ...
    private ArrayList<AppInformation> ShowList; // 应用统计时间列表
...
//        }
    ...
    private long getBeginTime() {
        ...
        if(style == WEEK) {
            ...
            calendar.add(java.util.Calendar.SECOND, -1 * second);
            calendar.add(java.util.Calendar.MINUTE, -1 * minute);
            calendar.add(java.util.Calendar.HOUR, -1 * hour);
